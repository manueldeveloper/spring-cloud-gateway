...
Actuator API can be enabled including the following maven dependency:
...
Actuator API is exposed to the following context: `/actuator/gateway`:
...
|===
|*Method*| POST
|*Description*| Refresh internal routes
|*URL Parameters*| -
|*Body*| -
|*Response*| -
|===
...
|===
|*Method*| GET
|*Description*| Returns all configured routes
|*URL Parameters*| -
|*Body*| -
|*Response*
a|
